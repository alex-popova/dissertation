"""
Django settings for capacityplanner project.
...
SECRET_KEY = 'django-insecure-00l9bcvhoz=c4&a9a+a^@hp3*eq8(m^&!f(-i3)h)8=pseum**'
...
ROOT_URLCONF = 'capacityplanner.urls'
...
WSGI_APPLICATION = 'capacityplanner.wsgi.application'
